...
described in `pprl-generation-workload-boundary.md`; shared declared funding and reservations are
implemented in `pprl-resource-boundary.md`. Remaining gates include Atlas learning
materialization and coordinated GC; authenticated identities, independent containment and forensic
capture, full environment-effect attribution, and independent resource metering;
